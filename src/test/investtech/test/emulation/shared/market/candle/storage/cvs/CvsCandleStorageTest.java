package investtech.test.emulation.shared.market.candle.storage.cvs;
...
import investtech.emulation.shared.market.candle.factory.CvsFileCandleStorageFactory;
import investtech.emulation.shared.market.candle.storage.cvs.CvsCandleStorage;
import investtech.emulation.shared.market.candle.storage.cvs.CvsTestConfig;
...
public class CvsCandleStorageTest {
    ...
    protected static final String SETTINGS_PATH = "src/test/resources/emulation.shared.market.candle.storage.cvs/test-settings.yaml";
    ...
    void testGetAt() throws IOException {
        ...
        var candleStorageFactory = new CvsFileCandleStorageFactory();
    ...
    void assertFindByOpenPrice(CvsCandleStorage candleStorage, FindPriceParams findPriceParams) {
    ...
    void assertPeriod(
            CvsCandleStorage candleStorage,
