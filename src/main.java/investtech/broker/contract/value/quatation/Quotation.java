...
public class Quotation {
    ...
    public Quotation div(long divideBy) {
        return div(BigDecimal.valueOf(divideBy));
    }

    public Quotation div(int divideBy) {
        return div(BigDecimal.valueOf(divideBy));
    }

    public Quotation div(Quotation divideBy) {
        return div(divideBy.toBigDecimal());
    }

    public Quotation div(BigDecimal divideBy) {
