...
import investtech.configuration.validation.ValidatorManager;
...
public class ServiceContainer {
    ...
    public Object get(Class<?> serviceClass) throws FactoryNotFoundException {
    ...
    protected ConfigurationInterface getConfig(String serviceId) {
        for (String mapping : serviceConfigMappings) {
            ...
            assert config instanceof ConfigurationInterface;

            if (((ConfigurationInterface) config).has(serviceId)) {
                return (ConfigurationInterface) ((ConfigurationInterface) config).get(serviceId);
            }
        }
